      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">สถานพยาบาลทั้งหมด</dt>
                <dd className="text-lg font-medium text-gray-900">{overviewData?.totalFacilities || 0}</dd>
              </dl>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">บุคลากรแพทย์</dt>
                <dd className="text-lg font-medium text-gray-900">{overviewData?.totalStaff || 0}</dd>
              </dl>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">เตียงทั้งหมด</dt>
                <dd className="text-lg font-medium text-gray-900">{overviewData?.totalBeds || 0}</dd>
              </dl>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">อัตราการใช้เตียง</dt>
                <dd className="text-lg font-medium text-gray-900">{overviewData?.bedOccupancyRate || 0}%</dd>
              </dl>
            </div>
          </div>
        </div>
