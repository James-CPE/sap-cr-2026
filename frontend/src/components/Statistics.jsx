    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-sm font-medium text-gray-500">ผู้ป่วยนอก</div>
          <div className="text-2xl font-bold text-blue-600">{totalStats.outpatients.toLocaleString()}</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-sm font-medium text-gray-500">ผู้ป่วยใน</div>
          <div className="text-2xl font-bold text-green-600">{totalStats.inpatients.toLocaleString()}</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-sm font-medium text-gray-500">ฉุกเฉิน</div>
          <div className="text-2xl font-bold text-red-600">{totalStats.emergency_cases.toLocaleString()}</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-sm font-medium text-gray-500">การผ่าตัด</div>
          <div className="text-2xl font-bold text-purple-600">{totalStats.surgeries.toLocaleString()}</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-sm font-medium text-gray-500">การคลอด</div>
          <div className="text-2xl font-bold text-pink-600">{totalStats.births.toLocaleString()}</div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="text-sm font-medium text-gray-500">เสียชีวิต</div>
          <div className="text-2xl font-bold text-gray-600">{totalStats.deaths.toLocaleString()}</div>
        </div>
      </div>
